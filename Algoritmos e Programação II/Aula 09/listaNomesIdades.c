/*
 * Arquivo:     listaNomesIdades.c
 * Data:        2020-11-12
 * Disciplina:  Algoritmos e Programação II
 * Descrição:   Programa para criar arquivo tipo texto e 
 *              gravar nome de pessoa e idade. A leitura e
 *              gravação de pessoas no arquivo vai até que
 *              o nome fim seja digitado pelo teclado
